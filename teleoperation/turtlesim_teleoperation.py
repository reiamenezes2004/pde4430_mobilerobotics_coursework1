...
>>>>>>> 2d5b59f04a5e65b69fabbc6c0c42bd0b9725fefc
...
# defining the key presses functions
def on_press(key):
    ...
    try:
        ...
        # asks the user for speed input when 's' is pressed
            ...
            sys.stdout.write("\r")  # clear the line where 's' was printed. resolves the alphahumeric issue
            sys.stdout.flush()
            prompt_for_speed()
...
# main function to handle tuttlesim teleoperation
def teleop_turtle():
